...
import type { VocabWord } from "@/content/english";
      ...
      {!flipped ? (
        <div className="flex flex-1 flex-col items-start justify-center">
          <div className="flex items-center gap-2">
            ...
            <span onClick={speak} role="button" aria-label="Pronounce" className="rounded-full p-1 text-muted hover:text-primary">
